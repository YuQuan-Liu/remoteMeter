...
function submitForm(){
	$('#addneighborbtn').linkbutton('disable');
...
<!-- 					<td><input class="easyui-textbox" type="text" name="neighborName" id="neighborName" data-options="required:true,delay:2500" validType="checkNbrName['#neighborName']"/></td> -->
		 ...
		 <div style="text-align:center;padding:5px">
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitForm()" id="addneighborbtn"><fmt:message key='common.submit'/></a>
		</div>
	</form>
</body>
</html>