	...
	<div style="margin:10px;">
		<form id="" method="post">
			<div>
	    		...
	    		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="readNeighbor()" >关阀</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="readNeighbors()" >再次提醒</a>
			</div>
		</form>
	</div>
