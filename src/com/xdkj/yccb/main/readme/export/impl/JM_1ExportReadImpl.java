...
public class JM_1ExportReadImpl implements ExportRead {
	...
	public void download(HttpServletRequest request,
		...
		//产生数据  并将数据放到response
		List<ReadView> list = readDao.getNonRemoteMeters(nid_list.get(0)+"");
...
//					new JDBField("cbrq", 'D', 8, 0)};
			...
			for(int i =0;i<list.size();i++){
				...
				Object[] record = { 
						...
						view.getReaddata(),//new JDBField("PPOINT", 'N', 9, 0),
